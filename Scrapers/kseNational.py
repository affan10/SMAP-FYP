...
def spider():
    ...
    print "Crawling from KseStocks National..."
    #nltk.download('stopwords')

    r = requests.get("http://www.ksestocks.com/NewsCentral/National_News")
...
#schedule.every().day.at("01:00").do(spider(),'It is 01:00')
